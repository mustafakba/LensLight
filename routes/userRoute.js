...
router.route('/:id').put(authMiddleware.authenticateToken,userController.follow)
router.route('/:id').put(authMiddleware.authenticateToken,userController.unfollow)
